jQuery(function($) {
	...
	if ( $(mapWrapperID).length > 0 && window.google && window.google.maps ) {
		...
		window.mapOps = {
			lat : 24.429170,	// Provide your latitude
			lng : 54.618330, // Provide your longitude
			content: '<p>Soft Fork Technology ,FD - Ground Floor, Accelerator Building, Masdar City, Abu Dhabi, UAE</p>', // Provide your address to show on pop up
